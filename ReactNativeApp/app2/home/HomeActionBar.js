...
import {Platform, View, Dimensions, Text,TextInput, StyleSheet, TouchableOpacity, Image} from 'react-native';
...
export default  class HomeActionBar extends Component {
    ...
    city() {
        this.props.navigation.navigate('SelectCityPage')
    }
            ...
            <View >
                <View style={styles.headerStyle}>
                    ...
                    <TouchableOpacity style={styles.searchBar}>
                        ...
                        <TextInput style={styles.searchText} placeholder='输入商家、商品名称' />
                    </TouchableOpacity>
